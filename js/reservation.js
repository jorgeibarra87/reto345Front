...
function readFormReservationData() {
  ...
  formData["devolutionDate"] = document.getElementById(
    "reservationDevolutionDate"
  ).value;
  formData["client"] = {
    idClient: parseInt(document.getElementById("reservationClientId").value),
  };
  formData["ortopedic"] = {
    id: parseInt(document.getElementById("reservationOrtopedicId").value),
  };
  return formData;
}
...
function reservationSelect(td) {
  ...
  document.getElementById("reservationDevolutionDate").value =
    selectedRow.cells[2].innerHTML;
  document.getElementById("reservationClientId").value =
    selectedRow.cells[3].innerHTML;
  document.getElementById("reservationOrtopedicId").value =
